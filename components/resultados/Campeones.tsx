      ...
      {isLoading ? (
        ...
        <Grid container display="flex" justifyContent="center">
          <Grid item md={5} xs={12} sx={{ textAlign: "center" }}>
            <Typography variant="subtitle1">Posiciones Finales</Typography>
            {/* <FormControl fullWidth>
              ...
              >
                <MenuItem value="campeon">Campeon</MenuItem>
                <MenuItem value="sub">Subcampeon</MenuItem>
            ...
            {objeto &&
              objeto.slice(1).map((p: any) => (
                ...
                >
                  ...
                  {p[1].map((x: any) => (
                    <Grid key={x.campeon} display="flex" flexDirection="column">
                      <Box display="flex">
                        <Box
                          sx={{ marginLeft: "15px" }}
                          display="flex"
